 ...
 * load com.cybozu.labs.langdetect.profiles with {@link DetectorFactory#loadProfile(String)} method
...
public class DetectorFactory {
    ...
    private static List<String> getProfileNames() throws IOException {
    ...
    public static void loadProfileFromClasspath(String resource) throws LangDetectException {
        try {
            ...
            for (String profileName : profileNames) {
                InputStream is = null;
                try {
                    is = ResourceLoader.getInputStreamForResource(profileName);
    ...
    /**
     * Load com.cybozu.labs.langdetect.profiles from specified directory.
     * This method must be called once before language detection.
     *
     * @param profileDirectory profile directory path
     * @throws LangDetectException Can't open com.cybozu.labs.langdetect.profiles(error code = {@link ErrorCode#FileLoadError})
    ...
    public static void loadProfile(List<String> json_profiles) throws LangDetectException {
        ...
        if (langsize < 2)
            throw new LangDetectException(ErrorCode.NeedLoadProfileError, "Need more than 2 com.cybozu.labs.langdetect.profiles");
    ...
    /**
     * Clear loaded language com.cybozu.labs.langdetect.profiles (reinitialization to be available)
     */
    ...
    static private Detector createDetector() throws LangDetectException {
        if (instance_.langlist.size() == 0)
            throw new LangDetectException(ErrorCode.NeedLoadProfileError, "need to load com.cybozu.labs.langdetect.profiles");
